 ...
 */
package plugins.quorum.Libraries.Development.Environment;
...
//            String destinationPath = "'/home/lejos/programs'"; //works for Windows
            ...
            if (checkAck(in) != 0) {
                Logger.getLogger(Lego.class.getName()).log(Level.INFO, "Error in input buffer after connecting channels");
                out.close();
                channel.disconnect();
                session.disconnect();
                return false;
            ...
            out.flush();
            if (checkAck(in) != 0) {
                Logger.getLogger(Lego.class.getName()).log(Level.INFO, "Error in input buffer after writing command to output");
                out.close();
                channel.disconnect();
                session.disconnect();
                return false;
            ...
            out.flush();
            if (checkAck(in) != 0) {
                Logger.getLogger(Lego.class.getName()).log(Level.INFO, "Error in input buffer after writing '\0' to output");
                out.close();
                channel.disconnect();
                session.disconnect();
                return false;
            ...
            Logger.getLogger(Lego.class.getName()).log(Level.INFO, null, e);
            try {
                if (fis != null) {
                    fis.close();
                }
            } catch (Exception ee) {
                Logger.getLogger(Lego.class.getName()).log(Level.INFO, null, ee);
            }
            return false;
        }
        return true;
